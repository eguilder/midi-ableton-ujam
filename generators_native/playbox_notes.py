...
output_dir = "notes_playbox"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

notes_data = [
    {"file_note": "C3", "track_name": "Chord 1 C3"},
    {"file_note": "D3", "track_name": "Chord 2 D3"},
    {"file_note": "E3", "track_name": "Chord 3 E3"},
    {"file_note": "F3", "track_name": "Chord 4 F3"},
    {"file_note": "G3", "track_name": "Chord 5 G3"},
    {"file_note": "A3", "track_name": "Chord 6 A3"},
    {"file_note": "B3", "track_name": "Chord 7 B3"},
    {"file_note": "C4", "track_name": "Chord 8 C4"},
]



print("=" * 70)
print("PLAYBOX CHORDS NOTE GENERATOR WITH TRACK-NAME FILENAMES")
print("=" * 70)
