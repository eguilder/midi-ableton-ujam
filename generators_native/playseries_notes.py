...
output_dir = "notes_playseries"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# List of notes with their custom track names
notes_data = [
    {"file_note": "C3",  "track_name": "Pattern 1 C3"},
    {"file_note": "C#3", "track_name": "Pattern 2 C#3"},
    {"file_note": "D3",  "track_name": "Pattern 3 D3"},
    {"file_note": "D#3", "track_name": "Pattern 4 D#3"},
    {"file_note": "E3",  "track_name": "Pattern 5 E3"},
    {"file_note": "F3",  "track_name": "Pattern 6 F3"},
    {"file_note": "F#3", "track_name": "Pattern 7 F#3"},
    {"file_note": "G3",  "track_name": "Pattern 8 G3"},
    {"file_note": "G#3", "track_name": "Pattern 9 G#3"},
    {"file_note": "A3",  "track_name": "Pattern 10 A3"},
    {"file_note": "A#3", "track_name": "Pattern 11 A#3"},
    {"file_note": "B3",  "track_name": "Pattern 12 B3"},
    {"file_note": "C4",  "track_name": "Pattern 13 C4"},
    {"file_note": "C#4", "track_name": "Pattern 14 C#4"},
    {"file_note": "D4",  "track_name": "Pattern 15 D4"},
    {"file_note": "D#4", "track_name": "Pattern 16 D#4"},
]

print("=" * 70)
print("PLAY SERIES NOTE GENERATOR WITH TRACK-NAME FILENAMES")
print("=" * 70)
