...
output_dir = "notes_s-trk01"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

notes_data = [
    # Kick Sounds (C1–G1)
    {"file_note": "C1",  "track_name": "Kick Sound 1 C1"},
    {"file_note": "C#1", "track_name": "Kick Sound 2 C#1"},
    {"file_note": "D1",  "track_name": "Kick Sound 3 D1"},
    {"file_note": "D#1", "track_name": "Kick Sound 4 D#1"},
    {"file_note": "E1",  "track_name": "Kick Sound 5 E1"},
    {"file_note": "F1",  "track_name": "Kick Sound 6 F1"},
    {"file_note": "F#1", "track_name": "Kick Sound 7 F#1"},
    {"file_note": "G1",  "track_name": "Kick Sound 8 G1"},

    # Kick Patterns (C2–G2)
    {"file_note": "C2",  "track_name": "Kick Pattern 1 C2"},
    {"file_note": "C#2", "track_name": "Kick Pattern 2 C#2"},
    {"file_note": "D2",  "track_name": "Kick Pattern 3 D2"},
    {"file_note": "D#2", "track_name": "Kick Pattern 4 D#2"},
    {"file_note": "E2",  "track_name": "Kick Pattern 5 E2"},
    {"file_note": "F2",  "track_name": "Kick Pattern 6 F2"},
    {"file_note": "F#2", "track_name": "Kick Pattern 7 F#2"},
    {"file_note": "G2",  "track_name": "Kick Pattern 8 G2"},

    # Bass Sounds (C3–G3)
    {"file_note": "C3",  "track_name": "Bass Sound 1 C3"},
    {"file_note": "C#3", "track_name": "Bass Sound 2 C#3"},
    {"file_note": "D3",  "track_name": "Bass Sound 3 D3"},
    {"file_note": "D#3", "track_name": "Bass Sound 4 D#3"},
    {"file_note": "E3",  "track_name": "Bass Sound 5 E3"},
    {"file_note": "F3",  "track_name": "Bass Sound 6 F3"},
    {"file_note": "F#3", "track_name": "Bass Sound 7 F#3"},
    {"file_note": "G3",  "track_name": "Bass Sound 8 G3"},

    # Bass Patterns (C4–G4)
    {"file_note": "C4",  "track_name": "Bass Pattern 1 C4"},
    {"file_note": "C#4", "track_name": "Bass Pattern 2 C#4"},
    {"file_note": "D4",  "track_name": "Bass Pattern 3 D4"},
    {"file_note": "D#4", "track_name": "Bass Pattern 4 D#4"},
    {"file_note": "E4",  "track_name": "Bass Pattern 5 E4"},
    {"file_note": "F4",  "track_name": "Bass Pattern 6 F4"},
    {"file_note": "F#4", "track_name": "Bass Pattern 7 F#4"},
    {"file_note": "G4",  "track_name": "Bass Pattern 8 G4"},
]



print("=" * 70)
print("TRK 01 NOTE GENERATOR WITH TRACK-NAME FILENAMES")
print("=" * 70)
