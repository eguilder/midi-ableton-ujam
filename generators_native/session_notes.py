...
output_dir = "notes_session"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

notes_data = [
    {"file_note": "C1",  "track_name": "Phrase 1 C1"},
    {"file_note": "C#1", "track_name": "Phrase 2 C#1"},
    {"file_note": "D1",  "track_name": "Phrase 3 D1"},
    {"file_note": "D#1", "track_name": "Phrase 4 D#1"},
    {"file_note": "E1",  "track_name": "Phrase 5 E1"},
    {"file_note": "F1",  "track_name": "Phrase 6 F1"},
    {"file_note": "F#1", "track_name": "Phrase 7 F#1"},
    {"file_note": "G1",  "track_name": "Phrase 8 G1"},
]

print("=" * 70)
print("SESSION PLAYER SERIES NOTE GENERATOR WITH TRACK-NAME FILENAMES")
print("=" * 70)
