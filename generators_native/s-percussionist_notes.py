...
output_dir = "notes_s-percussionist"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

notes_data = [
    # Inst 1
    {"file_note": "C1", "track_name": "Inst 1 Ph 1 C1"},
    {"file_note": "C#1", "track_name": "Inst 1 Ph 2 C#1"},
    {"file_note": "D1", "track_name": "Inst 1 Ph 3 D1"},
    {"file_note": "D#1", "track_name": "Inst 1 Ph 4 D#1"},
    {"file_note": "E1", "track_name": "Inst 1 Ph 5 E1"},

    # Inst 2
    {"file_note": "C2", "track_name": "Inst 2 Ph 1 C2"},
    {"file_note": "C#2", "track_name": "Inst 2 Ph 2 C#2"},
    {"file_note": "D2", "track_name": "Inst 2 Ph 3 D2"},
    {"file_note": "D#2", "track_name": "Inst 2 Ph 4 D#2"},
    {"file_note": "E2", "track_name": "Inst 2 Ph 5 E2"},

    # Inst 3
    {"file_note": "C3", "track_name": "Inst 3 Ph 1 C3"},
    {"file_note": "C#3", "track_name": "Inst 3 Ph 2 C#3"},
    {"file_note": "D3", "track_name": "Inst 3 Ph 3 D3"},
    {"file_note": "D#3", "track_name": "Inst 3 Ph 4 D#3"},
    {"file_note": "E3", "track_name": "Inst 3 Ph 5 E3"},

    # Inst 4
    {"file_note": "C4", "track_name": "Inst 4 Ph 1 C4"},
    {"file_note": "C#4", "track_name": "Inst 4 Ph 2 C#4"},
    {"file_note": "D4", "track_name": "Inst 4 Ph 3 D4"},
    {"file_note": "D#4", "track_name": "Inst 4 Ph 4 D#4"},
    {"file_note": "E4", "track_name": "Inst 4 Ph 5 E4"},
]


print("=" * 70)
print("SESSION PERCUSSIONIST NOTE GENERATOR WITH TRACK-NAME FILENAMES")
print("=" * 70)
